...
import { ReturnStatus, ReturnReason } from '../entities/return.entity';
...
export class QueryReturnsDto {
  ...
  @ApiProperty({ description: 'Return status filter', enum: ReturnStatus, required: false })
  @IsOptional()
  @IsEnum(ReturnStatus)
  status?: ReturnStatus;

  @ApiProperty({ description: 'Return reason filter', enum: ReturnReason, required: false })
  @IsOptional()
  @IsEnum(ReturnReason)
  reason?: ReturnReason;
